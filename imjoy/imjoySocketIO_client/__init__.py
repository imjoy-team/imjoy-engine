...
from .transports import (
    WebsocketTransport,
    XHR_PollingTransport,
    prepare_http_session,
    TRANSPORTS,
)
...
try:
    __version__ = get_distribution("socketIO-client")
except:
    pass
...
class EngineIO(LoggingMixin):
    ...
    def _ping(self, engineIO_packet_data=""):
        ...
        self._transport_instance.send_packet(engineIO_packet_type, engineIO_packet_data)
...
class SocketIO(EngineIO):
    ...
    def _process_packet(self, packet):
        ...
        try:
            ...
            raise PacketError("unexpected socket.io packet type (%s)" % packet.type)
        delegate(packet)
        return packet
