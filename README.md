...
* Go to https://imjoy.io, click the 🚀 icon located upper-right corner, select `Add Jupyter-Engine` and paste the link you get previously, and connect to the plugin engine. Once connected, you can start to run python plugins through the plugin engine.
